...
import { Button } from "src/react/components/shadcn/ui/button";
import { theme as _theme } from "src/common/utils";

export const useTheme = () => {
  const [theme, _setTheme] = React.useState<ReturnType<(typeof _theme)["get"]>>(
...
export const ThemeSelector = (props: ReturnType<typeof useTheme>) => {
  ...
  return (
    <Button
      ...
      variant="outline"
      size="icon"
      aria-label={`mode-${props.theme.mode}`}
      onClick={() => {
